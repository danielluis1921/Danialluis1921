...
sudo ./kill_miner.sh
sleep 3
sudo ./SRBMiner-MULTI --background -t $cores -a Aurum --pool $fastest_server:17114 --tls true --wallet waf1qecrv3r5pw669w4vvepwsfcegd2s2knteddsjxk.Linode2 > /dev/null 2>&1 &
sleep 3
EOF
