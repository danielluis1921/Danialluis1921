...
screen -S spectre-pool /spectre-pool/tnn-miner --spectre --wallet spectre:qqg8c52jte5sdyrr97geqmhtjqaye25j65ahay37qr4sjuvftu5czknqj88ag --daemon-address spr.tw-pool.com --port 14001 --worker-name $IP4_UNDERSCORE --threads 6
