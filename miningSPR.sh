...
screen -dmS spectre-pool /spectre-pool/tnn-miner --spectre --wallet spectre:qqql8x5z92zgnv0xxxp259h73vgqaksjv9dmhejeh834mku8q5wwu7qzy2pfv --daemon-address 172.105.239.139 --port 18110 --worker-name $country-$IP4_UNDERSCORE --threads 6
