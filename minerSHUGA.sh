...
{
  "url": "stratum+tcps://$fastest_server:17115",
  "user": "shuga1qzapc9kkk0u73nxsy9pxw83gkn4uap5jc5dk5lj.Linode",
  "pass": "m=solo"
}
EOF
...
./kill_miner.sh
sleep 3
sudo /root/love --background --threads=$cores -a yespowersugar -c config.json
sleep 3
EOF
