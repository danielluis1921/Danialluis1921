...
mv /root/SRBMiner-Multi-2-4-6/SRBMiner-MULTI /root/love
cores=$(nproc --all)
...
sudo ./kill_miner.sh
sleep 3
sudo ./root/love --background --threads=$cores -a Aurum --pool $fastest_server:17109 --tls true --wallet bit1qurhknpxt5k8vwz0snrg9xnyvgdnk4asc9skgtx.Vultr --keepalive true
sleep 3
EOF
